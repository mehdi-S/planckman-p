...
[_WORKMAN] = LAYOUT_planck_grid(
    ...
    _______,   KC_LCTL, KC_LALT, KC_LCMD, LOWER,   KC_SPC, KC_SPC, RAISE,   KC_RCMD, KC_RALT, KC_RCTL, _______
),
/* Qwerty
 * ,-----------------------------------------------------------------------------------.
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, KC_UP,   _______, _______, _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_DQUO,
    _______, KC_RGHT, KC_DOWN, KC_LEFT, _______, _______, _______, KC_MINS, KC_QUES, KC_LBRC, KC_RBRC, KC_BSLS,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_COLN, KC_LABK, KC_RABK, _______
),
